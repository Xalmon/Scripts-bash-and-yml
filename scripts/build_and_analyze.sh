...
mvn -B verify org.sonarsource.scanner.maven:sonar-maven-plugin:sonar -Dsonar.projectKey=Karrabo-Identity-Management -Dsonar.projectName='Karrabo-Identity-Management'
